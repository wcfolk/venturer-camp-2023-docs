...
% command to set links to black for printed docs
\newcommand{\printCopy}{\hypersetup{hidelinks}}
...
% BLACK AND WHITE TITLE PAGE FOR PRINTED DOCS
\newcommand{\bookTitlebw}[4]{
    \begin{titlepage} % Suppresses headers and footers on the title page
        ...
        \begin{figure}[H]
            \begin{minipage}{0.45\textwidth}
                \centering
                \includegraphics[width=0.45\textwidth]{../vc23-bw.png} %this will be replaced with vc23 logo when we have one
            \end{minipage}\hfill
            \begin{minipage}{0.45\textwidth}
                \centering
                \includegraphics[width=0.45\textwidth]{../wcf-bw.png}
            \end{minipage}\hfill
        \end{figure}
    ...
    \fancyhead[L]{#1}
    \fancyfoot[L]{\footnotesize{\texttt{#4-print}\\\texttt{\today}}}
}
...
% BLACK AND WHITE BACK PAGE FOR PRINTED DOCS
\newcommand{\backPagebw}{
    \begin{titlepage}
        \centering
        \rule{\textwidth}{0pt}
        \vfill
        \begin{figure}[H]
            \begin{minipage}{0.45\textwidth}
                \begin{flushright}
                \includegraphics[width=0.1\textwidth]{../vc23-bw.png} %this will be replaced with vc23 logo when we have one
                \end{flushright}
            \end{minipage}\hfill
            \begin{minipage}{0.45\textwidth}
                \includegraphics[width=0.1\textwidth]{../wcf-bw.png}
            \end{minipage}\hfill
        \end{figure}

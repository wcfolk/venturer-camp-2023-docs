...
\begin{titlepage}
    ...
    %%%%%%%%%%%%%%%%%%%% Author Name %%%%%%%%%%%%%%%%%%%%
    \begin{pgfonlayer}{fg}
    \drawtext{\Large\textsc{Woodcraft Folk}\\\Large\textsc{February 2024}}{$(current page.east)+(-0.5,-5.2)$}{2cm}{0}{text=fg,anchor=east,align=right};
    \end{pgfonlayer}
...
\begin{titlepage}
    ...
    % \node[left, bg, rounded corners, minimum height=2cm, rotate=0, text=fg,anchor=east,align=right, text width=25em] at ($(current page.east)+(-0.5,-10.7)$){Venturer Camp 2023, a project by \href{https://woodcraft.org.uk}{Woodcraft Folk}, brought together 13-17 year olds from across the UK to camp together and live by the Woodcraft Folk values for a week in the summer of 2023.\\
    % Woodcraft Folk is a registered charity in England \& Wales (1148195) and in Scotland (SC039791), and a limited company, registered in England \& Wales (8133727). Registered office: Holyoake House, Hanover Street, Manchester M60 0AS};

    % bottom right
    \foreach \i in {21} {\drawhexagon{}{$(current page.south east)+(-0.2,-0.45)$}{\i cm}{0}{accent!85,draw};}

    \node[left, bg, rounded corners, minimum height=2cm, rotate=0, text=fg,anchor=east,align=right, text width=15.25em] at ($(current page.east)+(-0.5,-10.6)$){Venturer Camp 2023, a project by \href{https://woodcraft.org.uk}{Woodcraft Folk}, brought together 13-17 year olds from across the UK to camp together and live by the Woodcraft Folk values for a week in the summer of 2023.\\
    Woodcraft Folk is a registered charity in England \& Wales (1148195) and in Scotland (SC039791), and a limited company, registered in England \& Wales (8133727). Registered office: Holyoake House, Hanover Street, Manchester M60 0AS};
